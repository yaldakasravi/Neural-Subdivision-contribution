...
def main():
    ...
    for epoch in range(params['epochs']):      
        ...
        for mIdx in range(S.nM):
            ...
            #NOTE YALDA
            #NOTE reading the curvature separetly to save time and compute
            curves = S.get_curve()
            #print(curves[0][0].shape)
            #input(" hope lives here ")
            outputs = net(x,mIdx, S.hfList, S.poolMats, S.dofs, curves)
    ...
    # NOTE save the output to check how the methods work differently
    # save loss history
